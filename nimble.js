 ...
 *  1.2.2:
 *  Supports relative click positioning for Mouse and Touch when context is not 'window'
 *  1.2.0:
 *  Keyboard.steps, Mouse.steps, Touch.steps, Orientation.steps (default: false) enable or disable step-based updates
 *	IO Components are now uninstantiated classes and accept a context as an optional constructor input
 */
...
var nimble = new (function(){'use strict';
	...
	var Mouse = function(context) {var t=this; if(!(t instanceof Mouse)) throw "Bad instantiation of object nimble.Mouse";
		...
		var icodes=[null,"left","middle","right"];
